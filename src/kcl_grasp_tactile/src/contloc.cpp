...
private:
	...
	kcl_grasp_msgs::KCL_ContactStateStamped ContactState,ContactState_ant;
...
Contact::Contact()
{
	...
	KCL_ContactState_pub_ant=n.advertise<kcl_grasp_msgs::KCL_ContactStateStamped>("ContactState",10);
	KCL_ContactState_pub=n.advertise<kcl_grasp_msgs::KCL_ContactStateStamped>("ContactState_new",10);
